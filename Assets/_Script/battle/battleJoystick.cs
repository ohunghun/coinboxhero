...
using UnityEngine;
using mTypes;
public class battleJoystick : Singleton<battleJoystick>
{
    ...
    List<callbackVector2> callbackmove = new List<callbackVector2>();
    public void addCallbackMove(callbackVector2 callback)
    {
        callbackmove.Add(callback);
    }
    protected  void move(Vector2 direction)
    {
        foreach(callbackVector2 callback in callbackmove)
            callback(direction);
    }
}
